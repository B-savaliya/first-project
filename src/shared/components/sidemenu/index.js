...
import Bird from "../../../assests/logos/bird-colorful.avif";
export default function Sidemenu() {
    return (
        <div>
            <div className="sidemenu">
                <div className="sidemenu-dp">
                    <img src={Bird} />
                </div>
                <div className="sidemenu-detail">
                    <a href="/">
                        <div className="sidemenu-text sidemenu-dashboard ">
                            <svg
                                width="30px"
                                height="30px"
                                viewBox="0 0 24 24"
                    ...
                    <a href="/setting">
                        <div className="sidemenu-text sidemenu-setting">
                            <svg
                                width="30px"
                                height="30px"
                                viewBox="0 0 24 24"
                    ...
                    <a href="/notification">
                        <div className="sidemenu-text sidemenu-notification">
                            <svg
                                width="30px"
                                height="30px"
                                viewBox="0 0 24 24"
                            ...
                            >
                                <g id="style=linear">
                                    <g id="notification-bell-new">
                                        ...
                                        <path
                                            id="vector_2"
                                            d="M18.7917 10.9112C18.8915 11.7454 19.1223 12.5607 19.4774 13.3265L19.7421 13.8972C20.7516 16.0741 19.4369 18.6186 17.0773 19.0547L16.9171 19.0843C13.4921 19.7174 9.9301 19.7174 6.55497 19.0843C4.17606 18.6446 2.91751 16.0127 4.06867 13.885L4.29508 13.4665C4.91326 12.3239 5.23697 11.0453 5.23697 9.74614L5.23697 8.42485C5.23697 6.20106 6.49561 4.16885 8.48651 3.1781C10.2177 2.3166 12.1995 2.15641 14.0267 2.70339"
                                            stroke="#000000"
                                            stroke-width="1.5"
                                            stroke-linecap="round"
                                        />
